			        ...
			        <ul class="nav-menu">
			          ...
			          <li class="menu-has-children"><a href="">Registration</a>
			            <ul>
			              ...
			              <li><a href="registerExaminer.jsp">Teacher Register</a></li>
			            </ul>
			          </li>	
			          <li class="menu-has-children"><a href="">Login</a>
			            <ul>
		              		<li><a href="LoginAdmin.jsp">Admin Login</a></li>		
		              		<li><a href="LoginExaminer.jsp">Teacher Login</a></li>		
					...
					<div class="row">
						<div class="col-lg-2 col-md-6 col-sm-6">
							<div class="single-footer-widget">
								<h4>Top Products</h4>
								<ul>
									<li><a href="#">Managed Web-site</a></li>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">Colorlib</a> &amp; distributed by <a href="https://themewagon.com" target="_blank">ThemeWagon</a>
