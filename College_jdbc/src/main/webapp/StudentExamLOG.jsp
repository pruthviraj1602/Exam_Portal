...
<body>
    ...
    <header>
        ...
        <div class="message">
            ...
            <img src="https://media.geeksforgeeks.org/wp-content/uploads/20221210183322/8.png"
                 ...
                 alt="">
            <div class="dp">
              <a href="student_profile.jsp"> <img src="https://media.geeksforgeeks.org/wp-content/uploads/20221210180014/profile-removebg-preview.png"
                    class="dpicn"
                    alt="dp"></a>
              </div>
        </div>
                ...
                <div class="nav-upper-options">
                    ...
                    <div class="option2 nav-option">
                        <img src="https://media.geeksforgeeks.org/wp-content/uploads/20221210183322/9.png"
                            class="nav-img"
                            alt="articles">
                       <a href="student_exam.jsp"><h3>Exam</h3></a>
                    </div>
                    ...
                    <div class="nav-option logout">
                      ...
                      <a href="Logout_student_servlet">  <h3>Logout</h3></a>
                    </div>
    ...
    <div class="report-header">
        <h2 class="recent-Articles">Validation For Exam</h2>
    </div>

    <div class="report-body">
        <!-- Your existing report content here -->

        <!-- Add your form inside the report container -->
        <form action="Student_exam_servlet" method="post" class="custom-form">
             <input type="hidden" name="em" value="<%= user.getEmail()%>">
             <input type="hidden" name="pass" value="<%= user.getPassword()%>">
             
            <label for="example1"><b>Email:</b></label>
            <input type="text" id="example1" name="email"  placeholder="Please Enter Registered Email" required>

            <label for="example2"><b>Password:</b></label>
            <input type="password" id="example2" name="password" placeholder="Please Enter Registered Password"  required>
            
            <label for="role"><b>Select Subject:</b></label>
   				 <select id="role" name="subject">
