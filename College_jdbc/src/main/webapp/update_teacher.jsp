...
<body>
    ...
    <div class="report-body">
        <div class="form-container">
            ...
            <form id="registrationForm" action="teacher_update_servlet" method="post">
           <%
              try{
            	  int id=Integer.parseInt(request.getParameter("id"));
            	  Promodel pm=new Promodel(jdbc_conn.getConnection());
            	  List<examiner_register> li=pm.examiner(id);
            	  for(examiner_register e:li){
           ...
           %>
                ...
                <div class="form-group">
                         ...
                         <input type="text" id="fullname" name="name" value="<%=e.getName()%>">
                </div>
                <div class="form-group">
                    <label for="email1">Address</label>
                    <input type="text" id="email1" name="address" placeholder="Enter Address" value="<%=e.getAddress()%>">
                </div>
                <div class="form-group">
                    <label for="email1">Email</label>
                    <input type="email" id="email1" name="email" placeholder="Enter email" value="<%=e.getEmail()%>">
                </div>
                <div class="form-group">
                    <label for="email2">Password</label>
                    <input type="password" id="email2" name="password" placeholder="Enter Password" value="<%=e.getPassword()%>">
                </div>
      ...
      <!-- Add more options as needed -->
               ...
               <label for="categories">Select Subject:</label>
                <select id="categories" name="subject">
